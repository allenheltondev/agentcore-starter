...
// what the DynamoDB-stream vectorizer (example/backend functions/vectorize-turn)
// consumes to build semantic memory — keeping the write path (recordTurn)
// fast and the embedding cost off the request path, exactly as
// content-tracking does with its Content entity.
//
//   pk = MEMORY#{userId}
